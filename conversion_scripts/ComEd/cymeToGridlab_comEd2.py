...
def convertCymeModel(network_db, equipment_db, type=1, feeder_id=None, primaryLoadOnly=True, ugConfig='', equipments=None, overheadlineConfig=None):
    ...
    return header_glmTree, network_glmTree, equipment_glmTree, caps_glmTree, load_glmTree, x_scale, y_scale
...
def _tests(database, feederID, keepFiles=True, primaryLoadOnly=True, ugConfig=''):
    ...
    exceptionCount = 0       
    try:
        header, networkDict1, equipment, capsDict, loads, x, y = convertCymeModel(database, database, type=1, feeder_id=feederID,
...
def _tests2(database, feederID1, feederID2, keepFiles=True, primaryLoadOnly=True, ugConfig=''):
    import os, json, traceback, shutil
    exceptionCount = 0
    try:
        equipmentDict = {}
        olcDict = {}
        headerDict1, networkDict1, equipmentDict1, capsDict1, loadDict1, x1, y1 = convertCymeModel(database, database, type=1, feeder_id=feederID1,
                                           primaryLoadOnly=primaryLoadOnly, ugConfig=ugConfig, equipments=equipmentDict, overheadlineConfig=olcDict)
        headerDict2, networkDict2, equipmentDict2, capsDict2, loadDict2, x2, y2 = convertCymeModel(database, database, type=1, feeder_id=feederID2,
                                           primaryLoadOnly=primaryLoadOnly, ugConfig=ugConfig, equipments=equipmentDict, overheadlineConfig=olcDict)
...
if __name__ == '__main__':
    if len(sys.argv) == 5:
        ...
        warnings.warn("Usage: python cymeToGridlab_comEd2.py databaseFullPath undergroundConfigGLMFilePath feederID1 [feederID2]")
