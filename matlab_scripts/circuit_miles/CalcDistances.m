% This script should be run after NodeLinkList.m has created the basic
% "nodeList.mat" and "linkList.mat" outputs
%  - It walk through the NodeLinkList and try to calculate distance from
%    the swing node. 
%
%  TODO: This is not quite perfect yet. It gets confused if there are small
%  loops in the system, especially those that have multiple phases coming 
%  together at a single node.  These nodes are mapped into the later circuit
%  view, but show up only as points (rather than a connection to another
%  node).
% 
